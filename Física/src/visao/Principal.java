...
public class Principal extends JFrame implements ActionListener {
    ...
    public Principal() {
        ...
        calcularButton.addActionListener(this); // Ajustado para chamar o método diretamente
    ...
    public void calcular() {
        try {
            ...
            // Constantes
            double k = 9 * Math.pow(10, 9); // Constante eletrostática

            // Cálculos
            double eSuperficie = (k * carga) / Math.pow(raio, 2);
            double e3metros = (k * carga) / Math.pow(3, 2);
            ...
            String resultado = String.format(
                ...
                "Campo elétrico a 3 metros do centro: %s N/C",
                df.format(eSuperficie), df.format(e3metros)
            );
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
        calcular(); // Chama diretamente o método de cálculo
    }
}
